...
class FoodEvent extends StatefulWidget {
  const FoodEvent({Key? key}) : super(key: key);

  @override
  _FoodEvent createState() => _FoodEvent();
}

class _FoodEvent extends State<FoodEvent> {
  get title => null;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder(
          stream: event.where('type',isEqualTo:'Food&Drink').snapshots(),
