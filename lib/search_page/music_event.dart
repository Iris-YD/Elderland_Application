...
class MusicEvent extends StatefulWidget {
  const MusicEvent({Key? key}) : super(key: key);

  @override
  _MusicEvent createState() => _MusicEvent();
}

class _MusicEvent extends State<MusicEvent> {
  get title => null;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder(
          stream: event.where('type',isEqualTo:'Music').snapshots(),
