...
class SportsEvent extends StatefulWidget {
  const SportsEvent({Key? key}) : super(key: key);

  @override
  _SportsEvent createState() => _SportsEvent();
}

class _SportsEvent extends State<SportsEvent> {
  get title => null;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder(
          stream: event.where('type',isEqualTo:'Sports').snapshots(),
