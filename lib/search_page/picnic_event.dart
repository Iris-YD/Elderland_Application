...
class PicnicEvent extends StatefulWidget {
  const PicnicEvent({Key? key}) : super(key: key);

  @override
  _PicnicEvent createState() => _PicnicEvent();
}

class _PicnicEvent extends State<PicnicEvent> {
  get title => null;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder(
          stream: event.where('type',isEqualTo:'Picnic').snapshots(),
