...
class OutdoorEvent extends StatefulWidget {
  const OutdoorEvent({Key? key}) : super(key: key);

  @override
  _OutdoorEvent createState() => _OutdoorEvent();
}

class _OutdoorEvent extends State<OutdoorEvent> {
  get title => null;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: StreamBuilder(
          stream: event.where('type',isEqualTo:'Outdoor').snapshots(),
